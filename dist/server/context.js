...
export class ContextManager {
    createContextItem(payload, addedBy) {
    ...
    isVisibleTo(item, participantId) {
    ...
    filterVisibleContext(context, participantId) {
    ...
    updateContentRef(item, newRef) {
        item.content_ref = newRef;
        item.updated_at = new Date().toISOString();
    }
    updateContent(item, newContent) {
