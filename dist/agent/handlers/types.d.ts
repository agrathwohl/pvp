 ...
 */
export type ToolCategory = "read-only" | "write-safe" | "write-dangerous" | "system-modify" | "network" | "destructive";
/**
 ...
 */
export type BroadcastFn = (messageType: string, payload: Record<string, unknown>, options?: {
    ref?: MessageId;
}) => Promise<MessageId>;
/**
 ...
 */
export interface ApprovableToolHandler<TArgs, TResult extends ToolExecutionResult = ToolExecutionResult> extends BaseToolHandler<TArgs, TResult> {
    /**
     ...
     */
    createProposal(args: TArgs, toolUseId: string, context: ToolHandlerContext): Promise<ToolProposalResult>;
}
/**
