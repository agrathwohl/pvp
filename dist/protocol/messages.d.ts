 ...
 */
import type { AnyMessage, MessageEnvelope, PrimitiveType, PayloadFor, SessionId, ParticipantId, MessageId, ForkId } from "./types.js";
/**
 ...
 * ```
 */
export declare function createMessage<T extends PrimitiveType>(type: T, session: SessionId, sender: ParticipantId, payload: PayloadFor<T>, options?: {
    ref?: MessageId;
    seq?: number;
 ...
 * ```
 */
export declare function isMessageType<T extends PrimitiveType>(message: AnyMessage, type: T): boolean;
/**
 ...
 * ```
 */
export declare function serializeMessage(message: AnyMessage): string;
/**
 ...
 * ```
 */
export declare function deserializeMessage(data: string): AnyMessage;
